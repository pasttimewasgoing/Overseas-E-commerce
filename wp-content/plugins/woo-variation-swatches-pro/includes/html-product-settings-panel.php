			...
			<div id="woo-variation-swatches-variation-product-option-settings-wrapper">
				...
				<div class="product-label-settings">
					...
					<div class="form-settings-group">
						...
						<?php
						$settings_id = woo_variation_swatches()->get_backend()->get_edit_panel()->settings_id( 'default_to_button' );
						...
						<div class="form-field">
							<select style="width: 200px" class="wc-enhanced-select" id="<?php echo esc_attr( $settings_id ); ?>" name="<?php echo esc_attr( $name ); ?>">
					...
					<div class="form-settings-group">
						<?php
						$settings_id = woo_variation_swatches()->get_backend()->get_edit_panel()->settings_id( 'default_to_image' );
					...
					<div class="form-settings-group">
						...
						<?php
						$settings_id = woo_variation_swatches()->get_backend()->get_edit_panel()->settings_id( 'default_image_type_attribute' );
						...
						<div class="form-field">
							<select style="width: 300px" class="wc-enhanced-select" id="<?php echo esc_attr( $settings_id ); ?>" name="<?php echo esc_attr( $name ); ?>">
								<option <?php selected( $current, '' ); ?> value=""><?php esc_html_e( 'Global', 'woo-variation-swatches-pro' ); ?></option>
					...
					<?php if ( wc_string_to_bool( woo_variation_swatches()->get_option( 'enable_catalog_mode', 'no' ) ) ) : ?>
						<div class="form-settings-group">
							...
							<?php
							$settings_id = woo_variation_swatches()->get_backend()->get_edit_panel()->settings_id( 'catalog_mode_attribute' );
							...
							?>
							<div class="form-label">
								<label for="<?php echo esc_attr( $settings_id ); ?>"><?php esc_html_e( 'Catalog mode attribute', 'woo-variation-swatches-pro' ); ?></label>
					...
					<?php if ( wc_string_to_bool( woo_variation_swatches()->get_option( 'enable_single_variation_preview', 'no' ) ) ) : ?>
						<div class="form-settings-group">
							<?php
							$settings_id = woo_variation_swatches()->get_backend()->get_edit_panel()->settings_id( 'single_variation_preview_attribute' );
							...
							?>
							<div class="form-label">
								<label for="<?php echo esc_attr( $settings_id ); ?>"><?php esc_html_e( 'Single Variation Image Preview Attribute', 'woo-variation-swatches-pro' ); ?></label>
