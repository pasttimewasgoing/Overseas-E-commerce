...
$is_edit = isset( $_GET['action'] ) && ( 'edit-group' === $_GET['action'] ) && isset( $_GET['slug'] );
							...
							<tr>
								<td>
									...
									<div class="row-actions">
										<span class="edit"><a href="<?php echo esc_url( wp_nonce_url( $edit_link . '&amp;slug=' . $slug, 'woo_variation_swatches_group' )); ?>"><?php esc_html_e( 'Edit', 'woo-variation-swatches-pro' ); ?></a> | </span>
										<span class="delete"><a class="delete" href="<?php echo esc_url( wp_nonce_url( $delete_link . '&amp;slug=' . $slug, 'woo_variation_swatches_group' )); ?>"><?php esc_html_e( 'Delete', 'woo-variation-swatches-pro' ); ?></a></span>
									</div>
