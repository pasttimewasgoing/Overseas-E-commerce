<?php
	...
	<div class="wvs-archive-variations-wrapper" data-threshold_min="<?php echo absint( $variation_threshold_min ); ?>" data-total_attribute="<?php echo absint( $total_attribute ); ?>" data-threshold_max="<?php echo absint( $variation_threshold_max ); ?>" data-total_children="<?php echo absint( $total_children ); ?>" data-product_id="<?php echo absint( $product->get_id() ); ?>" data-product_variations="<?php echo esc_attr(  $variations_attr); ?>">
