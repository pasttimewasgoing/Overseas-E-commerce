...
namespace WooCommerceCategorySlider\ByteKit\Admin;

use WooCommerceCategorySlider\ByteKit\Plugin;
...
class Notices
{
    ...
    public function add($args)
    {
        ...
        $args = wp_parse_args($args, array('message' => '', 'type' => 'info', 'dismissible' => true, 'capability' => 'manage_options', 'notice_id' => '', 'class' => '', 'style' => ''));
