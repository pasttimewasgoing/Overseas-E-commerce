...
namespace WooCommerceCategorySlider\ByteKit;

use WooCommerceCategorySlider\ByteKit\Admin\Flash;
use WooCommerceCategorySlider\ByteKit\Admin\Notices;
use WooCommerceCategorySlider\ByteKit\Interfaces\Pluginable;
use WooCommerceCategorySlider\ByteKit\Traits\HasPlugin;
...
abstract class Plugin implements Pluginable
{
    ...
    final public static function create($data = null)
    {
        ...
        if (!isset(static::$instances[$plugin])) {
            ...
            if (false === $plugin_data) {
                $headers = array('name' => 'Plugin Name', 'plugin_uri' => 'Plugin URI', 'version' => 'Version', 'description' => 'Description', 'author' => 'Author', 'author_uri' => 'Author URI', 'text_domain' => 'Text Domain', 'domain_path' => 'Domain Path', 'network' => 'Network', 'requires_wp' => 'Requires at least', 'requires_php' => 'Requires PHP', 'requires_plugins' => 'Requires Plugins', 'support_url' => 'Support URL', 'docs_url' => 'Docs URL', 'api_url' => 'API URL', 'review_url' => 'Review URL', 'settings_url' => 'Settings URL', 'item_id' => 'Item ID');
     ...
     * @return void
     */
    public function _register_textdomain()
    {
